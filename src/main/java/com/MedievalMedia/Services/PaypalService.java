...
public class PaypalService {
	 ...
	 * 
	 * @throws ResponseStatusException 
	 * 	CONFLICT: if user doesn't have enough money
	 * 	NOT_ACCEPTABLE: if the withdraw is lesser than $10 
	 * 	PAYMENT_REQUIRED: if it was a valid withdraw request, but that is not enough money in medieval media paypal account right now to fulfill this transaction
